  ...
  <div class="chat-window">
    ...
    <div class="botoom" style="background-color:rgb(50, 54, 68);">
      ...
      <div class="chatInputs">
        ...
        <!--输入框-->
        <el-input type="textarea"  id="textareaMsg" ref="textInput" :autosize="{}"  class="textarea" v-model="inputMsg" maxlength="2000" style="margin-left: 2%;margin-top: 3px;min-height: 51px;max-height:400px;max-width: 80%;min-width: 45%;  height: auto;"  @keydown.shift.enter="newLine" :rows="rows"  @keydown.enter.prevent placeholder="请说出你的问题~"></el-input>
        <div>
...
import { AI_HEAD_IMG_URL, USER_HEAD_IMG_URL, USER_NAME } from '@/hooks/mutation-types'
